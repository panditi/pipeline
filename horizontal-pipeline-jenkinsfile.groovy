...
node{
    stage("iac_iam_roles"){
        ...
        def functions = load "${/Users/sainavyapanditi/Documents/repos/pipeline/functions.groovy}"
        functions.Verticalpipelinejob(github_org,github_repo,github_repo_path,wgithub_repo_branch,environment)
